...
class view : public Gtk::TextView
{
    public:
        ...
        Glib::ustring get_buffer_text() {
            return buffer->get_text();
        }
        gint get_buffer_size() {
            return buffer->get_char_count();
        }
        gint get_buffer_line() {
        ...
        Glib::RefPtr <Gtk::Builder> get_xml() {
            return refBuilder;
        }
    ...
    protected:
        Glib::RefPtr<Gtk::TextTagTable> get_tag_table() {
            return tag_table;
        }
