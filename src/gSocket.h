...
public:
	...
	guint32 get_bytesSent() { return bytesSent; }
	guint32 get_bitsSent() { return bytesSent*8; }
	guint32 get_bytesReceived() { return bytesReceived; }
	guint32 get_bitsReceived() { return bytesReceived*8; }
	guint32 get_packetsSent() { return packetsSent; }
	guint32 get_packetsRecevied() { return packetsReceived; }
	guint32 get_bitsTotal() { return (bytesReceived + bytesSent) * 8; }
	bool netStatsEnabled() { return netStats; }
	void resetNetStats();
	void setNetStats(bool set) { netStats = set; resetNetStats(); }
	float bitFlow();
