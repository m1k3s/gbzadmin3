...
class gameStatView : public view
{
    public:
        ...
        void update();
        void setType(guint16 tmp) {
            type = tmp;
        }
        void setOptions(guint16 tmp) {
            options = tmp;
        }
        void setMaxPlayers(guint16 tmp) {
            maxPlayers = tmp;
        }
        void setMaxShots(guint16 tmp) {
            maxShots = tmp;
        }
        void setTotalPlayers(guint16 tmp) {
            total_players = tmp;
        }
        void setRogueSize(guint16 tmp) {
            rogueSize = tmp;
        }
        void setRedSize(guint16 tmp) {
            redSize = tmp;
        }
        void setGreenSize(guint16 tmp) {
            greenSize = tmp;
        }
        void setBlueSize(guint16 tmp) {
            blueSize = tmp;
        }
        void setPurpleSize(guint16 tmp) {
            purpleSize = tmp;
        }
        void setObsSize(guint16 tmp) {
            obsSize = tmp;
        }
        void setRogueMax(guint16 tmp) {
            rogueMax = tmp;
        }
        void setRedMax(guint16 tmp) {
            redMax = tmp;
        }
        void setGreenMax(guint16 tmp) {
            greenMax = tmp;
        }
        void setBlueMax(guint16 tmp) {
            blueMax = tmp;
        }
        void setPurpleMax(guint16 tmp) {
            purpleMax = tmp;
        }
        void setObsMax(guint16 tmp) {
            obsMax = tmp;
        }
        void setShakeWins(guint16 tmp) {
            shakeWins = tmp;
        }
        void setShakeTimeOut(guint16 tmp) {
            shakeTimeout = tmp;
        }
        void setMaxPlayerScore(guint16 tmp) {
            maxPlayerScore = tmp;
        }
        void setMaxTeamScore(guint16 tmp) {
            maxTeamScore = tmp;
        }
        void setMaxTime(guint16 tmp) {
            maxTime = tmp;
        }
        void setTimeElapsed(guint16 tmp) {
            timeElapsed = tmp;
        }
        void setTotalObservers(guint16 tmp) {
            total_observers = tmp;
        }
